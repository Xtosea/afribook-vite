...
className={  w-full   p-4   rounded-2xl   border   resize-none   transition-all   duration-200   focus:outline-none   focus:ring-2   focus:ring-blue-400   relative   z-0   h-28   ${fontStyle}  }
/>
...
<div className="space-y-4 border-t pt-4 relative z-10">    <p className="text-sm font-semibold text-gray-600">  
    Customize Post  
  </p>  {/* TEXT COLORS */}

<div className="flex gap-3 flex-wrap relative z-50">  <button
type="button"
...
/>
  ...
  {/* BACKGROUND OPTIONS */}    <div className="flex gap-2 flex-wrap">  <button  
  type="button"  
  onClick={() =>  
    setBackgroundStyle("white")  
  }  
...
The file is cut off. Kindly update the full file and give me the full update thanks.