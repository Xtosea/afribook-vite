...
{/* POST BUTTON */}  
    <button
  onClick={handlePost}
  className="fixed top-4 left-1/1 -translate-x-1/1 bg-blue text-white px-4 py-3 rounded-xl shadow-lg z-50"
>
  Post Story
</button>
...
{/* MEDIA PICKER BUTTON */} 
    ...
    <button
  onClick={() => fileRef.current?.click()}
  className="fixed bottom-30 right-4 bg-green 600 text-white p-2 rounded-xl shadow-lg z-50"
>
  📷 Add Photo / Video
</button>
