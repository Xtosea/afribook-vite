    ...
    <div className="flex h-full bg-gray-100 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        {selectedUser ? (
          <>
            {/* HEADER */}
            <div className="fixed top-10 left-0 right-0 z-30 bg-white border-b shadow-sm px-4 py-3 flex items-center justify-between">
   ...
   msg.updatedAt !== msg.createdAt && (
    <span className="text-[10px] opacity-70">
      (edited)
            ...
            {/* INPUT AREA */}
            <div className="fixed w-full bottom-[0px] mid:bottom-4 z-30 bg-white/80 border-t px-3 py-3 shadow-lg">
