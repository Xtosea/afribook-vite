...
import { FixedSizeList as List } from "react-window"; // Virtualized feed
...
const Home = () => {
  ...
  useEffect(() => {
    const init = async () => {
      ...
      // Connect socket after initial fetch
      connectSocket();
    ...
    return (
      <div style={style}>
        <PostCard
          ...
          onComment={() => {}}
          onShare={() => {}}
          setVideoRefs={setVideoRefs} // Collect video refs for lazy load
        />
      </div>
    );
  };
          ...
          <div ref={feedRef} className="space-y-4">
            {loadingPosts ? (
              ...
              <List
                ...
                itemSize={500} // Adjust based on post height
                width={"100%"}
              >
                {RenderPost}
              </List>
...
export default Home;/layout/SidebarRight";
import StoriesBar from "../components/layout/StoriesBar";
import StoryViewer from "../components/stories/StoryViewer";
import MediaUpload from "../components/MediaUpload";
import imageCompression from "browser-image-compression";
